...
难度：${diff}
要求：${diff === 'easy' ? '教科书级人物——全球或主要文化圈内几乎人人知晓' : diff === 'medium' ? '知名人物——有一定知名度但非教科书标配' : '冷门人物——较少人知道但有充分史料记载'}
...
难度：${diff}
要求：${diff === 'easy' ? '常见动植物——日常生活中能见到或耳熟能详' : diff === 'medium' ? '知名物种——有一定知名度但不那么常见' : '稀有或特殊物种——较少人知道但有明确科学记载'}
...
难度：${diff}
要求：${diff === 'easy' ? '日常常见物品——几乎人人都能见到或使用' : diff === 'medium' ? '知名发明产品——有知名度但非日常标配' : '特殊或冷门物品——较少人知道但有明确记载'}
...
难度：${diff}
要求：${diff === 'easy' ? '教科书级事件——几乎所有人都知道' : diff === 'medium' ? '知名历史事件——有一定知名度' : '较冷门事件——较少人知道但有明确史料记载'}
...
难度：${diff}
要求：${diff === 'easy' ? '经典知名角色——几乎所有观众都知道' : diff === 'medium' ? '较知名角色——有一定知名度' : '冷门角色——较少人知道但在作品中有明确设定'}
...
难度：${diff}
要求：${diff === 'easy' ? '知名地标城市——几乎所有人都知道' : diff === 'medium' ? '较知名地点——有一定知名度' : '冷门地点——较少人知道但有明确地理记载'}
